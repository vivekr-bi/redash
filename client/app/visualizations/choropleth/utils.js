...
export function inferCountryCodeType(mapType, data, countryCodeField) {
  const regexMap = {
    ...
    chandigarh_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    dadraNagar_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    delhi_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    puducherry_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    goa_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    damanDiu_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    sikkim_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    tripura_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    meghalaya_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    lakshadweep_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    nagaland_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    manipur_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    mizoram_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    himachalPradesh_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    arunachalPradesh_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    telangana_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    haryana_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    kerala_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    uttarakhand_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    punjab_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    jammuKashmir_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    andhraPradesh_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    jharkhand_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    chhattisgarh_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    assam_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    bihar_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    odisha_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    karnataka_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    tamilNadu_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    rajasthan_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    maharashtra_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    uttarPradesh_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    madhyaPradesh_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    andamanNicobar_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    westBengal_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
    gujarat_india: { name: /^[a-z]+$/i, id: /^[0-9]{1,3}$/i },
  };
