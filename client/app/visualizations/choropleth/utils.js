...
export function inferCountryCodeType(mapType, data, countryCodeField) {
  const regexMap = {
    ...
    chandigarh_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    dadraNagar_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    delhi_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    puducherry_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    goa_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    damanDiu_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    sikkim_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    tripura_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    meghalaya_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    lakshadweep_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    nagaland_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    manipur_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    mizoram_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    himachalPradesh_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    arunachalPradesh_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    telangana_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    haryana_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    kerala_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    uttarakhand_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    punjab_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    jammuKashmir_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    andhraPradesh_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    jharkhand_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    chhattisgarh_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    assam_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    bihar_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    odisha_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    karnataka_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    tamilNadu_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    rajasthan_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    maharashtra_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    uttarPradesh_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    madhyaPradesh_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    andamanNicobar_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    westBengal_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
    gujarat_india: { name: /^[a-z]+$/i, district_id: /^[0-9]+$/i },
  };
